...
class MainActivity : AppCompatActivity(), MainFragment.MainFragmentInteractionListener {
    ...
    //Creates binding variables so as not to use .findViewById
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //creates view for the fabButton
    ...
    //Creates new list item and calls keyboard for input
    ...
    //Opens prompt to get user input to create list item
    ...
    //Creates companion object to pass info between activities
    companion object {
        const val INTENT_LIST_KEY = "list"
        const val LIST_DETAIL_REQUEST_CODE = 123
    }

    //Passes List to method that creates the new activity
