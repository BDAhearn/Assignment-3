...
//Lets FAB button on detail view add items
class ListDetailActivity : AppCompatActivity() {
    ...
    //Retrieves list passed in as an extra
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction().replace(R.id.detail_container, fragment).commitNow()
        }
    }

    //Creates prompt for button
    ...
    //On back press, bundles intent to let the activity know everything went according to script
